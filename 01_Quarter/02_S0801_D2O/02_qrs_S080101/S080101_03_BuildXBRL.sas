...
PROC SQL;
	...
	CREATE TABLE WORK.QRS_S080101_PARTA_VW AS 
...
CREATE TABLE WORK.QRS_S080101_PARTB_VW AS  
	...
	SELECT 
			...
			, C0300_TBL.ei2521 AS C0300_XBRL INFORMAT=$200. FORMAT=$200. LENGTH=200 LABEL = ''
		...
		LEFT JOIN XBRL.ei2521 C0300_TBL
			ON C0300_TBL.ei2521_contextRef=CON.context_id	
