...
CREATE TABLE REC_SUM AS 
	...
	SELECT 
		'S080104_GROUP' AS QRT
		, 'SDW' AS SYSTEM LENGTH = 4
		, 'PART_A_CNT' AS QRT_PART
		, COUNT(*) AS COUNT 
		, SUM(C0240) AS MKT_VALUE
	FROM 
		SDW_S080104_PARTA_VW 
...
UNION ALL 
	...
	SELECT 
		...
		, SUM(A.C0240) - SUM(B.C0240) AS MKT_VALUE
	FROM 
		SDW_S080104_PARTA_VW  A , 
		QRG_S080104_PARTA_VW  B			
	WHERE 
		A.C0040=B.C0040
