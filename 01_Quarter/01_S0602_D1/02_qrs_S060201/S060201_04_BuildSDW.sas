...
SELECT 
	...
	, SUBSTR(TRIM(VALU.XBRL_CD),1,INDEX(TRIM(VALU.XBRL_CD),'/')-1) AS C0150_XBRL 
...
SELECT 
	...
	, LKTHRU.XBRL_CD AS C0292_XBRL INFORMAT=$100. FORMAT=$100. LENGTH=100 LABEL = ''
	, C0292 INFORMAT=$100. FORMAT=$100. LENGTH=100 LABEL = ''
	...
	, C0330 AS C0330 INFORMAT=$200. FORMAT=$200. LENGTH=200 LABEL = ''
	...
	, ROUND(C0370,0.01) AS C0370 FORMAT=12.2 INFORMAT=COMMA12. 
