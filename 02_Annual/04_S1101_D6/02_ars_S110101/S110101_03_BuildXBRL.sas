...
/* ------------------------------ */
/*  Build Part A from the XBRL   */
/* -----------------------------*/

PROC SQL;
	CREATE TABLE WORK.S110101_XBRL_PartA AS 
...
DATA WORK.ARS_S110101_PARTA_VW ;
	DROP  context_id context_ORDINAL scenario_ORDINAL;
	SET WORK.S110101_XBRL_PartA;
RUN;	


/* ------------------------------ */
/*  Build Part B from the XBRL   */
/* -----------------------------*/
PROC SQL;
	CREATE TABLE WORK.S110101_XBRL_PartB AS 
...
DATA WORK.ARS_S110101_PARTB_VW ;
	DROP  context_id context_ORDINAL scenario_ORDINAL;
	SET WORK.S110101_XBRL_PartB;
RUN;	

PROC DATASETS LIBRARY= WORK NOLIST;
	DELETE PART_A PART_B S110101_XBRL_PartA S110101_XBRL_PartB;
RUN;
