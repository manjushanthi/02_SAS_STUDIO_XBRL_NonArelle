...
CREATE TABLE REC_SUM AS 
	...
	SELECT 
		'S060201_SOLO_CIC' AS QRT
		, 'SDW' AS SYSTEM LENGTH = 4
		, 'PART_A_CNT' AS QRT_PART
		, COUNT(*) AS COUNT 
		, SUM(C0170) AS MKT_VALUE
	FROM 
		SDW_S060201_PARTA_VW 
...
UNION ALL 
	...
	SELECT 
		...
		, SUM(A.C0170) - SUM(B.C0170) AS MKT_VALUE
	FROM 
		SDW_S060201_PARTA_VW  A , 
		ARS_S060201_PARTA_VW  B			
	WHERE 
		A.C0040=B.C0040
