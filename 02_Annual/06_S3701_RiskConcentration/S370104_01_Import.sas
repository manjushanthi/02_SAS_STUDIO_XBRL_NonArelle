...
%LET XBRLFilePath = &InputFileFolder/DLG_S370104_(RiskConcentration)_Group_V260-Annual_2021 FROM INVESTMENTS.xbrl;
%LET SDWFilePath = &InputFileFolder/S370104_(RiskConcentration)_Group.xlsx;
