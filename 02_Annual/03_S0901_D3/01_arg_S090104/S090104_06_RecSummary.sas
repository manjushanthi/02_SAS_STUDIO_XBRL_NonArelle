...
CREATE TABLE REC_SUM AS 
	...
	SELECT 
		'S090104-D3_GROUP' AS QRT
		, 'SDW' AS SYSTEM LENGTH = 4
		, 'PART_A_CNT' AS QRT_PART
		, COUNT(*) AS COUNT 
		, SUM(C0100) AS MKT_VALUE
	FROM 
		SDW_S090104_PARTA_VW 
...
UNION ALL 
	...
	SELECT 
		...
		, SUM(A.C0100) - SUM(B.C0100) AS MKT_VALUE
	FROM 
		SDW_S090104_PARTA_VW  A , 
		ARG_S090104_PARTA_VW  B			
	WHERE 
		A.C0040=B.C0040
	;
